...
- **ReleaseMg production acceptance**：PARTIAL / NOT CLOSED（`docs/releases/releasemg-production-acceptance-2026-05-09.md`）；installed/version/enabled and popup-core have Product Owner manual evidence for the unpacked/local-load instance; bind-sync remains `PARTIAL` unless completed or explicitly waived/deferred/risk-accepted.
