...
- **ReleaseMg production acceptance**：PARTIAL / NOT CLOSED（`docs/releases/releasemg-production-acceptance-2026-05-09.md`）；installed/version have Product Owner manual evidence for the unpacked/local-load instance; enabled remains `PARTIAL`; popup core and bind-sync remain `BLOCKED` unless completed or explicitly waived/deferred/risk-accepted.
