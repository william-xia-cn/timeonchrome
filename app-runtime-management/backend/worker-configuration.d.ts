/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: a7256a42f40382c6154c80a473e40eff)
// Runtime types generated with workerd@1.20260828.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
	RELEASES: R2Bucket;
	RUNTIME_DB: D1Database;
	GUARDIAN_RUNTIME_ISSUER: string;
	RUNTIME_PAGES_ORIGIN: string;
	GUARDIAN_RUNTIME_PUBLIC_JWK: string;
	GUARDIAN_RUNTIME_SSO_PUBLIC_JWK: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GUARDIAN_RUNTIME_ISSUER" | "RUNTIME_PAGES_ORIGIN" | "GUARDIAN_RUNTIME_PUBLIC_JWK" | "GUARDIAN_RUNTIME_SSO_PUBLIC_JWK">> {}
}
