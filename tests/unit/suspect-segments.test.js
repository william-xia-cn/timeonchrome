...
(async () => {
  ...
  eq('stats outbox includes rebuilt date for cloud correction', JSON.stringify(outboxes.stats_sync_outbox_v1), JSON.stringify({ dirtyDates: ['2026-05-10', DAY], retryCounts: {}, lastErrors: {}, revisions: { [DAY]: 1 } }));
