...
function run() {
  ...
  expectTrue('Pages 网站归类审核应兼容缺 recordSource 的旧自动访问记录', source.includes('function hasSiteRequestObservationEvidence') && source.includes("request.recordSource === 'legacy') && hasSiteRequestObservationEvidence"));
