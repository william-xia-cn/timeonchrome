...
function run() {
  ...
  expectTrue('Pages 普通分类菜单不应允许归为特殊网站', source.includes('policyOptionsHtml(selected)') && source.includes('filter(def => !def.isSpecial)') && source.includes('特殊对象规则通过孩子端 Popup 申请'));
