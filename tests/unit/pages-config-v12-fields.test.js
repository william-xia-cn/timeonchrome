...
function run() {
  ...
  expectTrue('独立 Task 页面显示 capability 诊断设备清单', taskPageJs.includes('capability-device-list') && taskPageJs.includes('Task 上报') && taskPageJs.includes('taskSyncVersion') && taskPageJs.includes('onlineWindowMs') && taskPageJs.includes('windowMinutes') && taskPageJs.includes('分钟内'));
