...
function run() {
  ...
  expectTrue('系统访问配置 loader 应修正旧 D1 中的高风险站点分类漂移', systemConfigModule.includes('PROTECTED_SYSTEM_SITE_CLASSIFICATIONS') && systemConfigModule.includes("'cg.163.com': 'restricted'") && systemConfigModule.includes('applySystemAccessConfigInvariants') && systemConfigModule.includes('next.defaultRestrictedEntertainmentSites = withEnsuredHosts'));
