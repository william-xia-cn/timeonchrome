...
function run() {
  ...
  expectTrue('admin 本机状态设备名和 ID 应横向同列展示', extractFunctionSource(code, 'renderSyncStatus').includes('<span style="font-size:15px; font-weight:600;">${deviceName}</span>') && extractFunctionSource(code, 'renderSyncStatus').includes('ID: ${shortId}'));
