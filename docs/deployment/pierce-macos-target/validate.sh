...
echo "5. Confirm the installed manifest is version 1.7.12 and declares managed-storage-schema.json."
echo "6. Confirm managed activation adopts the Device Token without opening bind.html?welcome=1."
