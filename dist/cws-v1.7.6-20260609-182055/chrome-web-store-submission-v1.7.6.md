...
- Privacy policy remediation for Purple Nickel: the privacy policy describes user data collection, processing, storage, sharing, diagnostics, cloud sync, incognito sanitization, current permissions, retention/deletion controls, and the Chrome Web Store Limited Use statement.
